...
last_samurai = media.Movie("The Last Samurai",
                           "An American military officer training japan's first\
                            army in the art of modern warfare.",
...
the_gladiator = media.Movie("The Gladiator",
                            "The story of a once-powerful general forced to \
                            become a common gladiator.",
...
the_matrix = media.Movie("The Matrix",
                         "a computer programmer Neo, who is contacted by two \
                          hackers escaped from the matrix",
